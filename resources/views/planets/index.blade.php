                  ...
                  <tbody class="bg-white">
                    @foreach($planets as $planet)
                      <tr class="whitespace-nowrap">
                        ...
                        <td class="px-4 py-4">@if($planet->state) {{ __('Done') }} @else {{ __('To do') }} @endif</td>
                        ...
                        <form id="destroy{{ $planets->id }}" action="{{ route('planets.destroy', $planet->id) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                      </tr>
